    ...
    return (
        <React.Fragment>
            <Head>
                ...
                <title>Join JobArc – Start Organizing Your Job Hunt</title>
                <meta name="description" content="Create your JobArc account and begin managing and tracking all your job applications in one smart, organized place." />
            </Head>
            ...
            <div className="w-full md:fixed relative md:h-screen h-auto flex flex-col items-center justify-start md:overflow-hidden overflow-auto">
                ...
                {sessionStatus !== "authenticated" ? (
                    <div className="w-full min-h-0 bg-white">
                        <div className='w-full h-full flex flex-col items-center justify-center relative md:overflow-hidden overflow-auto'>

                            <div className="w-full flex flex-col row-start-2 items-center justify-center pt-8">

                                <div className="relative max-w-4xl md:min-w-2xl min-w-11/12 md:mb-14 mb-10 flex justify-center">
                                ...
                                <div className='w-full flex flex-col items-center justify-center montserrat'>

                                    {/* Personal Information */}
                                    <div className="max-w-2xl md:min-w-2xl md:w-2xl w-11/12 mb-16">
